            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body card-block">
                  <form action="teacher.php?action=exam_store" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9">
                        ...
                        <textarea name="question" id="question" rows="" placeholder="Question..." class="form-control"></textarea>
                      </div>
                    </div>
                    <div class="">
